#ifndef _ROS_tuw_uvc_Sphere_h
#define _ROS_tuw_uvc_Sphere_h
...
namespace tuw_uvc
{
  ...
  class Sphere : public ros::Msg
  {
    ...
    const char * getType(){ return "tuw_uvc/Sphere"; };
    const char * getMD5(){ return "5efbf77cd8050ef458b2f268af91ea62"; };
